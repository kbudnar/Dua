...
@implementation ShareKitDuaConfigurator
...
- (NSString*)twitterConsumerKey {
	return @"WJxDQ1WSDCw9AFFWNYapyg";
}

- (NSString*)twitterSecret {
	return @"IXlQgHSv7jj991KGPVWlyvxaqsF383njVw40VHPJ5BM";
}
// You need to set this if using OAuth, see note above (xAuth users can skip it)
- (NSString*)twitterCallbackUrl {
	return @"http://www.hawashi.net";
}
...
- (NSString*)bitLyKey {
	return @"R_6d09a1f14014a7e000e618a23299529e";
}
